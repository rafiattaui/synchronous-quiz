...
export const SAMPLE_QUESTIONS: Question[] = [
  {
    questionId: "1",
    order: 1,
    question: "Which programming language is known as the 'superset' of JavaScript?",
  ...
  },
  {
    questionId: "2",
    order: 2,
    question: "What is the time complexity of looking up a value in a Map by its key?",
